...
echo "enabled"
elif [ $(gsettings get org.gnome.settings-daemon.plugins.color night-light-enabled) == "true" ] ; then
echo "enabled"
...
if [ $GAMMAX = 1.0 ] | [ $GAMMAY = 1.0 ] | [ $GAMMAZ = 1.0 ]; then
echo "disabled"
elif [ $(gsettings get org.gnome.settings-daemon.plugins.color night-light-enabled) == "false" ] ; then
echo "disabled"
